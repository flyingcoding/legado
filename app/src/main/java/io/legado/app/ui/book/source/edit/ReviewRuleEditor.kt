...
internal fun Map<String, String?>.toReviewRuleOrNull(): ReviewRule? {
    ...
    return ReviewRule(
        ...
        imageListRule = value("imageListRule"),
        imageUrlRule = value("imageUrlRule"),
        imageWidthRule = value("imageWidthRule"),
        imageHeightRule = value("imageHeightRule"),
        imageFormatRule = value("imageFormatRule"),
        ...
        quoteImageListRule = value("quoteImageListRule"),
        quoteImageUrlRule = value("quoteImageUrlRule"),
        quoteImageWidthRule = value("quoteImageWidthRule"),
        quoteImageHeightRule = value("quoteImageHeightRule"),
        quoteImageFormatRule = value("quoteImageFormatRule"),
